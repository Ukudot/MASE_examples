...
<div class="container-fluid">
    <div class="row justify-content-center" style="min-height: 80svh;">
        <div class="col-4 m-5 p-4 rounded-3 shadow h-25">
                            ...
                            <div class="row">
                                <div id="kc-form-buttons" class="col-12">
                                    <input id="authenticateWebAuthnButton" type="button" onclick="webAuthnAuthenticate()" autofocus="autofocus"
                                           ...
                                           class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!} w-100 "/>
                                </div>
                            </div>
                        </div>
                    </div>

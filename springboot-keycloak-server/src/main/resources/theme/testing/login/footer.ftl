            ...
            <div class="it-brand-wrapper">
              <a href="#" data-focus-mouse="false">
                <div class="it-brand-text">
                  <h2>${properties.brandTitle}</h2>
                  <h3 class="d-none d-md-block">${properties.brandTagLine}</h3>
                </div>
              </a>
            </div>
          </div>
            ...
            <div class="pb-2">
              ...
              <ul class="list-inline text-left social">
                <li class="list-inline-item">
                  <a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top"><use xlink:href="${url.resourcesPath}/svg/sprites.svg#it-designers-italia"></use></svg><span class="visually-hidden">Designers Italia</span></a>
                </li>
                <li class="list-inline-item">
                  <a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top"><use xlink:href="${url.resourcesPath}/svg/sprites.svg#it-twitter"></use></svg><span class="visually-hidden">Twitter</span></a>
                </li>
                <li class="list-inline-item">
                  <a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top"><use xlink:href="${url.resourcesPath}/svg/sprites.svg#it-medium"></use></svg><span class="visually-hidden">Medium</span></a>
                </li>
                <li class="list-inline-item">
                  <a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top"><use xlink:href="${url.resourcesPath}/svg/sprites.svg#it-behance"></use></svg><span class="visually-hidden">Behance</span></a>
                </li>
              </ul>
            </div>
          </div>
...
<script type="text/javascript" src="${url.resourcesPath}/js/spid-sp-access-button.min.js"></script>
<script src="${url.resourcesPath}/js/bootstrap-italia.bundle.min.js"></script>
<script>
  bootstrap.loadFonts('${url.resourcesPath}/fonts');
</script>

<!DOCTYPE html><html lang="en"><head><script>
    window.kcContext=  
<#assign pageId="my-extra-page-2.ftl">
(()=>{
    ...
    out["messagesPerField"]= {
        <#assign fieldNames = [ "username", "email", "firstName", "lastName", "totp", "userLabel" ]>
    ...
    out["themeType"] = "account";
    out["themeName"] = "testing";
    out["pageId"] = "${pageId}";
...
<style>
:root {
    --urldfd9e168128b93f: url(${url.resourcesPath}/build/assets/titillium-web-v10-latin-ext_latin-700italic-CdIIZ-A-.woff2);
    ...
    -->
    <link rel="icon" type="image/png" sizes="32x32" href="${url.resourcesPath}/build/favicon-32x32.png">

    <title>Keycloakify starter</title>
    <link rel="preload" href="${url.resourcesPath}/build/fonts/WorkSans/worksans-bold-webfont.woff2" as="font" crossorigin="anonymous">
    <link rel="preload" href="${url.resourcesPath}/build/fonts/WorkSans/worksans-medium-webfont.woff2" as="font" crossorigin="anonymous">
    <link rel="preload" href="${url.resourcesPath}/build/fonts/WorkSans/worksans-regular-webfont.woff2" as="font" crossorigin="anonymous">
    <link rel="preload" href="${url.resourcesPath}/build/fonts/WorkSans/worksans-semibold-webfont.woff2" as="font" crossorigin="anonymous">
    ...
    <style>
      ...
      @font-face {
      	...
      	/*400*/
      	font-display: swap;
      	src: url(${url.resourcesPath}/build/fonts/WorkSans/worksans-regular-webfont.woff2) format("woff2");
      }
      ...
      @font-face {
      	...
      	font-weight: 500;
      	font-display: swap;
      	src: url(${url.resourcesPath}/build/fonts/WorkSans/worksans-medium-webfont.woff2) format("woff2");
      }
      ...
      @font-face {
      	...
      	font-weight: 600;
      	font-display: swap;
      	src: url(${url.resourcesPath}/build/fonts/WorkSans/worksans-semibold-webfont.woff2) format("woff2");
      }
      ...
      @font-face {
      	...
      	/*700*/
      	font-display: swap;
      	src: url(${url.resourcesPath}/build/fonts/WorkSans/worksans-bold-webfont.woff2) format("woff2");
      }
    </style>
    ...
    <script type="module" crossorigin="" src="${url.resourcesPath}/build/assets/index-CAmiuzXs.js"></script>
  </head>
